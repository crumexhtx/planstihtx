export const destinationDescriptions: Record<string, string> = {
  ...
  hanoi:
    'Vietnam’s historic capital offers a busy Old Quarter, lakeside walks, rich coffee culture, and exceptional local food.',
  marrakech:
  ...
  amsterdam:
    'A compact canal city known for cycling, major art museums, historic houses, and relaxed waterfront neighborhoods.',
  istanbul:
    'A city spanning Europe and Asia, blending imperial mosques, bazaars, Bosphorus views, and a deep culinary tradition.',
  dubai:
  ...
  orlando:
    'A family-focused destination best known for major theme parks, entertainment districts, resorts, and warm weather.',
  cancun:
    'A Caribbean resort destination with beaches, reefs, nightlife, and access to cenotes and Maya archaeological sites.',
  'rio-de-janeiro':
    'A dramatic coastal city framed by mountains, famous for beaches, samba, panoramic viewpoints, and Carnival culture.',
  'buenos-aires':
    'Argentina’s elegant capital offers tango, late-night dining, historic cafés, grand avenues, and passionate football culture.',
  'cape-town':
    'A scenic South African city surrounded by mountains, beaches, vineyards, and culturally rich coastal neighborhoods.',
  cairo:
